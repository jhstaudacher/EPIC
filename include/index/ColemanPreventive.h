...
public:
	/**
	 * Construct the ColemanPreventive object
	 *
	 * @param g The Game for which the ColemanPreventive index should be calculated.
	 ...
	 */
	ColemanPreventive(Game& g, ItfUpperBoundApproximation* approx, IntRepresentation int_representation = DEFAULT);
