...
std::vector<epic::bigFloat> epic::index::SymmetricCoalitionalBanzhaf::calculate(Game& g) {
	/*
...
epic::longUInt epic::index::SymmetricCoalitionalBanzhaf::getMemoryRequirement(Game& g) {
...
void epic::index::SymmetricCoalitionalBanzhaf::updateInternalShapleyShubik(Game& g, bigInt* internal_ssi, Array2dOffset<lint::LargeNumber>& cwi, longUInt precoalition, longUInt player, std::vector<longUInt>& weights, bigInt* factorial) {
